...
const LINKS = [
  ...
  { to: "/leaderboard", label: "Leaderboards", icon: Trophy, note: "Match, gross, net, teams. Also on the phone bar." },
  { to: "/matches", label: "Matches", icon: Swords, note: "Two-man best-ball. Net. Temporary partners." },
  ...
  { to: "/pairings", label: "Pairings", icon: Flag, note: "Draft until Seth publishes." },
